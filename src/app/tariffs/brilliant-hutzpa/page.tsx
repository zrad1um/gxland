    ...
    >
      ...
      >
        <main className="flex flex-col items-center gap-8 max-w-2xl text-center">
          ...
          >
            Тариф <span className="text-yellow-500">&quot;Блистательная хуцпа&quot;</span>
          </motion.h1>
          ...
          >
            Для тех, кто знает цену деньгам и умеет их зарабатывать
          </motion.p>
          ...
          {/* Описание тарифа */}
          <motion.div
            className="text-white text-shadow-gray-400 mt-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 0.8, duration: 0.6 }}
          >
            <p className="mb-4">
              Хуцпа (חוצפה) — особое качество, сочетающее дерзость, наглость и неуёмную энергию. 
              Этот тариф для тех, кто унаследовал от предков не только гены, но и коммерческую жилку.
            </p>
            
            <div className="bg-yellow-900 bg-opacity-30 p-4 rounded-lg border border-yellow-800 my-6">
              <h3 className="text-xl font-bold text-yellow-300 mb-2">Преимущества:</h3>
              <ul className="list-disc list-inside space-y-2 text-left">
                <li>Доступ к &quot;золотым&quot; бизнес-схемам</li>
                <li>Исключительное право торговаться</li>
                <li>Секреты увеличения капитала в 40 раз</li>
                <li>Настоящая еврейская смекалка в подарок</li>
                <li>Персональный менеджер по имени Мойша</li>
              </ul>
            </div>

            <p className="text-2xl font-bold text-yellow-400 mt-6">
              Всего 18 000 ₸ (число хаи) в месяц
            </p>
            <p className="text-sm text-white text-shadow-gray-400 mt-2">
              *18 — числовое значение слова &quot;хаи&quot; (חי) — &quot;жизнь&quot; на иврите
            </p>
          </motion.div>
          ...
          >
            <Link href="/tariffs/pf2" passHref className="w-full sm:w-auto flex-1 min-w-[200px]">
              <motion.button
                className="px-6 py-3 bg-gradient-to-r from-yellow-600 to-amber-500 hover:from-yellow-700 hover:to-amber-600 text-white rounded-full font-medium transition-colors w-full"
                whileHover={{ scale: 1.03 }}
                whileTap={{ scale: 0.97 }}
              >
                Оплатить со скидкой 18%
              </motion.button>
            </Link>
          ...
          >
            *Подписываясь, вы соглашаетесь с тем, что 10% от вашей будущей прибыли 
            будут перечисляться на наш счет, а ещё 20% на Армию обороны Израиля, которая продолжает свою
            военную операцию по освобождению исконно израильской провинции - Газы. Это не комиссия — это цдака.
          </motion.p>
        </main>
      </motion.div>
    </div>
