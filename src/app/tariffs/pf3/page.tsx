    ...
    >
      ...
      >
        <main className="flex flex-col items-center gap-6 w-full max-w-2xl">
          ...
          >
            Оформление <span className="text-rose-500">подписки</span>
          </motion.h1>
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-white mb-2">Ваши данные</h3>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white focus:ring-2 focus:ring-rose-500 focus:border-transparent"
                ...
                <div>
                  <label htmlFor="address" className="block text-sm font-medium text-white-300 mb-1">
                    Адрес
                  </label>
                  <input
                    type="text"
              ...
              {/* Данные карты */}
              <div className="space-y-4">
                <h3 className="text-xl font-semibold text-white mb-2">Данные карты</h3>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label htmlFor="cvv" className="block text-sm font-medium text-white mb-1">
                      CVV/CVC
                    </label>
                    <input
                      type="text"
                ...
                <div className="pt-6">
                  <div className="flex items-center justify-between p-3 bg-gray-800 rounded-lg border border-gray-700">
                    <span className="text-white">Сумма к оплате:</span>
                    <span className="text-md font-bold text-rose-400">427,346,529,110₸</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <Link href="/tariffs/thanksto" passHref className="w-full sm:w-auto flex-1 min-w-[200px]"/>
            <motion.button
              type="submit"
              className="w-full px-6 py-3 bg-gradient-to-r from-rose-600 to-pink-500 text-white font-bold rounded-lg shadow-lg hover:opacity-90 transition-opacity"
            ...
            <p className="text-xs text-white mt-4 text-center">
              Нажимая кнопку, вы соглашаетесь с тем, что мы имеем право списать любую сумму с вашей карты в любое время без предупреждения.
            </p>
          </motion.form>
          ...
          >
            <Link href="/" className="text-gray-200 hover:text-white text-sm flex items-center gap-1">
