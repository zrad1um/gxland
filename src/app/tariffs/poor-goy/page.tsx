    ...
    >
      ...
      >
        <main className="flex flex-col items-center gap-8 max-w-2xl text-center">
          ...
          >
            The <span className="text-red-500">«Poor little goy»</span> plan
          </motion.h1>
          ...
          >
            <p className="mb-4">
              ...
              <h3 className="text-xl font-bold text-red-300 mb-2">For a modest fee, you&#39;ll get:</h3>
            ...
            <p className="text-2xl font-bold text-red-400 mt-6">999₸ per month</p>
          </motion.div>
